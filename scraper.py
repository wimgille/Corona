...
def ExcessMort():
    ...
    zscore_0to4 = data["pooled"]["groups"][0]['zscore']
    total_number_deaths_0to4 = data["pooled"]["groups"][0]['nbc']
    baseline_deaths_0to4 = data["pooled"]["groups"][0]['pnb']
    excess_deaths_0to4 = data["pooled"]["groups"][0]['excess']
    si_deaths_0to4 = data["pooled"]["groups"][0]['si']
    hnr_deaths_0to4 = data["pooled"]["groups"][0]['hnr']
    lnr_deaths_0to4 = data["pooled"]["groups"][0]['lnr']

    zscore_15to64 = data["pooled"]["groups"][1]['zscore']
    total_number_deaths_15to64 = data["pooled"]["groups"][1]['nbc']
    baseline_deaths_15to64 = data["pooled"]["groups"][1]['pnb']
    excess_deaths_15to64 = data["pooled"]["groups"][1]['excess']
    si_deaths_15to64 = data["pooled"]["groups"][1]['si']
    hnr_deaths_15to64 = data["pooled"]["groups"][1]['hnr']
    lnr_deaths_15to64 = data["pooled"]["groups"][1]['lnr']

    zscore_5to14 = data["pooled"]["groups"][2]['zscore']
    total_number_deaths_5to14 = data["pooled"]["groups"][2]['nbc']
    baseline_deaths_5to14 = data["pooled"]["groups"][2]['pnb']
    excess_deaths_5to14 = data["pooled"]["groups"][2]['excess']
    si_deaths_5to14 = data["pooled"]["groups"][2]['si']
    hnr_deaths_5to14 = data["pooled"]["groups"][2]['hnr']
    lnr_deaths_5to14 = data["pooled"]["groups"][2]['lnr']
    ...
    df=pd.DataFrame({"Date":date, "zscore_tot":zscore_tot, "total_number_deaths_tot":total_number_deaths_tot, "baseline_deaths_tot":baseline_deaths_tot, "excess_deaths_tot":excess_deaths_tot, "si_deaths_tot": si_deaths_tot, "hnr_deaths_tot":hnr_deaths_tot, "lnr_deaths_tot": lnr_deaths_tot, \
        "zscore_0to4":zscore_0to4, "total_number_deaths_0to4":total_number_deaths_0to4, "baseline_deaths_0to4":baseline_deaths_0to4, "excess_deaths_0to4":excess_deaths_0to4, "si_deaths_0to4": si_deaths_0to4, "hnr_deaths_0to4":hnr_deaths_0to4, "lnr_deaths_0to4": lnr_deaths_0to4, \
        "zscore_15to64":zscore_15to64, "total_number_deaths_15to64":total_number_deaths_15to64, "baseline_deaths_15to64":baseline_deaths_15to64, "excess_deaths_15to64":excess_deaths_15to64, "si_deaths_15to64": si_deaths_15to64, "hnr_deaths_15to64":hnr_deaths_15to64, "lnr_deaths_15to64": lnr_deaths_15to64, \
        "zscore_5to14":zscore_5to14, "total_number_deaths_5to14":total_number_deaths_5to14, "baseline_deaths_5to14":baseline_deaths_5to14, "excess_deaths_5to14":excess_deaths_5to14, "si_deaths_5to14": si_deaths_5to14, "hnr_deaths_5to14":hnr_deaths_5to14, "lnr_deaths_5to14": lnr_deaths_5to14, \
